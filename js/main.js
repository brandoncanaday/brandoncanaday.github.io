$(document).ready(function() {
  ...
  const SQUARES = [
    ...
    },
    {
      ...
      type: "codepen",
      content:
        '<a data-label="codepen" class="icon-link codepen" href="https://codepen.io/brandoncanaday">' +
    ...
    },
    {
      ...
      type: "projects",
      content:
        '<a data-label="github" class="icon-link github" href="https://github.com/brandoncanaday">' +
  ...
  $(".me-wrap")
    .mouseenter(function() {
      ...
      $(".header").css(
        "boxShadow",
        "0px -30px 60px -25px blanchedalmond inset"
      );
